...
The clean referendum dataset comes from a series of individual sources as below.  I would like to acknowledge the sources of each of them for the work they've put in to making these data available.  In particular to John Lees-Miller, Hope Tho

mas & Andrew Weeks for the work they've done in putting together the EU funding data which can be seen on the myeu.uk website.
